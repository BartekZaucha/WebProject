var rootURL = "http://localhost:8080/reststeak-app/rest/users";
...
var validate = function() {
	...
	if ($('#inputUsername').val() == "" || $('#inputPassword').val() == "") {
		...
		if (user != null) {
			var userPasswd = user.password;
			var userRole = user.role;

			// Convert the password from the user to SHA1 encoded string and
			// compare with the password stored in DB.
			if (SHA1(password) == userPasswd) {
...
// This is used for comparing the password entered by the user with the password
// stored in DB.
function SHA1(msg) {
